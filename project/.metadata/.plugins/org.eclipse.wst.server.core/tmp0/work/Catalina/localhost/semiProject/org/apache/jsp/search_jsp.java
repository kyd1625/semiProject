 ...
 * Generated at: 2022-07-30 19:21:09 UTC
...
public final class search_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/common/header.jsp", Long.valueOf(1659182866325L));
 ...
 if(loginMember != null){ 
      ...
      out.write("                    <input class=\"form-control me-3\" type=\"text\" required>\r\n");
      out.write("                </div>\r\n");
      out.write("\r\n");
      out.write("                <div class=\"mb-3 pb-1 w-100 mb-sm-4 me-sm-3\">\r\n");
      ...
      out.write("                    <select class=\"form-select\" id=\"from-destination\">\r\n");
      ...
      out.write("                        <input class=\"form-control rounded date-picker\" type=\"text\" placeholder=\"Choose date\" data-datepicker-options=\"{ &quot;altFormat&quot;: &quot;F j, Y&quot;, &quot;dateFormat&quot;: &quot;Y.m.d&quot;, &quot;defaultDate&quot;: &quot;today&quot;, &quot;minDate&quot;: &quot;today&quot;}\"\r\n");
      ...
      out.write("\r\n");
      out.write("    <!-- 검색결과 시작 -->\r\n");
      out.write("    <div class=\"container py-4 mb-2 mb-sm-0 pb-sm-5\">\r\n");
      out.write("        <div class=\"row justify-content-center\">\r\n");
      out.write("            <div class=\"col-lg-11\">\r\n");
      out.write("                <nav aria-label=\"breadcrumb\">\r\n");
      out.write("                    <!-- <ol class=\"py-1 my-2 breadcrumb\">\r\n");
      out.write("                        <li class=\"breadcrumb-item\"><a href=\"index.html\">Home</a></li>\r\n");
      out.write("                        <li class=\"breadcrumb-item\"><a href=\"#\">Blog</a>\r\n");
      out.write("                        </li>\r\n");
      out.write("                        <li class=\"breadcrumb-item active\" aria-current=\"page\">List no sidebar</li>\r\n");
      out.write("                    </ol> -->\r\n");
      out.write("                </nav>\r\n");
      out.write("                </br>\r\n");
      out.write("                </br>\r\n");
      out.write("                <h2 class=\"mb-5\">검색결과</h2>\r\n");
      out.write("                <hr style=\"border: solid 1px; color : #9A161F;\">\r\n");
      out.write("                <!-- Post-->\r\n");
...
if(searchList.size()<2) { 
      ...
      out.print( searchList.get(0).getPrfnm() );
      out.write("</h3>\r\n");
      out.write("                                <p class=\"fs-sm text-muted mb-2\">");
      out.print( searchList.get(0).getPrfcast() );
      out.write("</p>\r\n");
      out.write("                                <p class=\"fs-sm text-muted mb-2\">");
      out.print( searchList.get(0).getPrfpdfrom() );
      out.write('~');
      out.print( searchList.get(0).getPrfpdto() );
      out.write("</p>\r\n");
      out.write("                            </div>\r\n");
      out.write("                        </a>\r\n");
      out.write("                    </div>\r\n");
      ...
      out.write("                            <a class=\"card-img-top\" href=\"#\" style=\"background-image: url(");
      out.print(searchList.get(i).getPoster() );
      out.write(");\"></a>\r\n");
      out.write("                            <div class=\"card-body\">\r\n");
      out.write("                                <h2 class=\"h4 nav-heading text-capitalize mb-3\"><a href=\"#\">");
      out.print( searchList.get(i).getPrfnm() );
      out.write("</a></h2>\r\n");
      out.write("                                <p class=\"mb-0 fs-sm text\"> ");
      out.print( searchList.get(i).getPrfruntime() );
      out.write(' ');
      out.write('|');
      out.write(' ');
      out.print( searchList.get(i).getPrfage());
      out.write("</br>\r\n");
      out.write("                                    출연 : ");
      out.print(searchList.get(i).getPrfcast() );
      out.write("\r\n");
      out.write("                                </p>\r\n");
      out.write("                            </div>\r\n");
      out.write("                        </article>\r\n");
...
if(searchList.size()<2) { 
      ...
      out.write("    <div class=\"container py-4 mb-20 mb-sm-0 pb-sm-10\" style=\"margin-top:140px;\">\r\n");
      out.write("        <nav aria-label=\"breadcrumb\">\r\n");
      out.write("        </nav>\r\n");
      out.write("        <h2 class=\"mb-5\">추천목록</h2>\r\n");
      out.write("        <hr style=\"border: solid 1px; color : #9A161F;\">\r\n");
      out.write("        <!-- Blog grid-->\r\n");
      out.write("        <div class=\"masonry-grid overflow-hidden\" data-columns=\"5\">\r\n");
      out.write("            <!-- Post-->\r\n");
      out.write("            <div class=\"masonry-grid-item\">\r\n");
      out.write("                <article class=\"card card-hover\">\r\n");
      out.write("                    <a class=\"card-img-top\" href=\"blog-single-rs.html\"><img src=\"img/blog/shin.jpg\" alt=\"Post thumbnail\"></a>\r\n");
      out.write("                    <div class=\"card-body\">\r\n");
      out.write("                        <h2 class=\"h5 nav-heading mb-3\"><a href=\"blog-single-rs.html\">신바람 삼대</a></h2>\r\n");
      out.write("                        <a class=\"meta-link fs-sm mb-2\" href=\"#\">2020.12.10 ~ 2022.08.31</a>\r\n");
      out.write("                        <a class=\"d-flex meta-link fs-sm align-items-center pt-3\" href=\"https://map.kakao.com/?urlX=500684.0&urlY=1134149.0&name=%EB%8C%80%ED%95%99%EB%A1%9C+%EC%95%84%ED%8A%B8%ED%8F%AC%EB%A0%88%EC%8A%A4%ED%8A%B8+2%EA%B4%80\">\r\n");
      out.write("                            <i class=\"fa-solid fa-landmark\" alt=\"Emma Brown\"></i>\r\n");
      out.write("                            <div class=\"ps-2 ms-1 mt-n1 \"><span class=\"fw-semibold \">아트포레스트 2관</span></div>\r\n");
      out.write("                        </a>\r\n");
      out.write("                    </div>\r\n");
      out.write("                </article>\r\n");
      out.write("            </div>\r\n");
      ...
      out.write("            <div class=\"masonry-grid-item\">\r\n");
      out.write("                <article class=\"card card-hover\">\r\n");
      out.write("                    <a class=\"card-img-top\" href=\"blog-single-rs.html\"><img src=\"img/blog/hang.jpg\" alt=\"Post thumbnail\"></a>\r\n");
      out.write("                    <div class=\"card-body\">\r\n");
      out.write("                        <h2 class=\"h5 nav-heading mb-3\"><a href=\"blog-single-rs.html\">행오버</a></h2>\r\n");
      out.write("                        <a class=\"meta-link fs-sm mb-2\" href=\"#\">2022.01.21 ~ 2022.07.31</a>\r\n");
      out.write("                        <a class=\"d-flex meta-link fs-sm align-items-center pt-3\" href=\"https://map.kakao.com/?urlX=500876.0&urlY=1133736.0&name=%EC%A0%95%EA%B7%B9%EC%9E%A5\">\r\n");
      out.write("                            <i class=\"fa-solid fa-landmark\" alt=\"Emma Brown\"></i>\r\n");
      out.write("                            <div class=\"ps-2 ms-1 mt-n1 \"><span class=\"fw-semibold \">정극장</span></div>\r\n");
      out.write("                        </a>\r\n");
      out.write("                    </div>\r\n");
      out.write("                </article>\r\n");
      out.write("            </div>\r\n");
      ...
      out.write("            <div class=\"masonry-grid-item\">\r\n");
      out.write("                <article class=\"card card-hover\">\r\n");
      out.write("                    <a class=\"card-img-top\" href=\"blog-single-rs.html\"><img src=\"img/blog/yeon.jpg\" alt=\"Post thumbnail\"></a>\r\n");
      out.write("                    <div class=\"card-body\">\r\n");
      out.write("                        <h2 class=\"h5 nav-heading mb-3\"><a href=\"blog-single-rs.html\">연애하기 좋은 날</a></h2>\r\n");
      out.write("                        <a class=\"meta-link fs-sm mb-2\" href=\"#\">2022.07.09 ~ 2022.09.25</a>\r\n");
      out.write("                        <a class=\"d-flex meta-link fs-sm align-items-center pt-3\" href=\"https://map.kakao.com/?urlX=501139.0&urlY=1133244.0&name=%EC%9A%B0%EB%A6%AC%EC%86%8C%EA%B7%B9%EC%9E%A5\">\r\n");
      out.write("                            <i class=\"fa-solid fa-landmark\" alt=\"Emma Brown\"></i>\r\n");
      out.write("                            <div class=\"ps-2 ms-1 mt-n1 \"><span class=\"fw-semibold \">우리소극장</span></div>\r\n");
      out.write("                        </a>\r\n");
      out.write("                    </div>\r\n");
      out.write("                </article>\r\n");
      out.write("            </div>\r\n");
      ...
      out.write("            <div class=\"masonry-grid-item\">\r\n");
      out.write("                <article class=\"card card-hover\">\r\n");
      out.write("                    <a class=\"card-img-top\" href=\"blog-single-rs.html\"><img src=\"img/blog/chung.jpg\" alt=\"Post thumbnail\"></a>\r\n");
      out.write("                    <div class=\"card-body\">\r\n");
      out.write("                        <h2 class=\"h5 nav-heading mb-3\"><a href=\"blog-single-rs.html\">청년 윤봉길</a></h2>\r\n");
      out.write("                        <a class=\"meta-link fs-sm mb-2\" href=\"#\">2022.07.21 ~ 2022.07.24</a>\r\n");
      out.write("                        <a class=\"d-flex meta-link fs-sm align-items-center pt-3\" href=\"https://map.naver.com/v5/entry/place/11621559?c=14138771.1581117,4506020.1154957,13,0,0,0,dh&placePath=%2Fhome&entry=plt\">\r\n");
      out.write("                            <i class=\"fa-solid fa-landmark\" alt=\"Emma Brown\"></i>\r\n");
      out.write("                            <div class=\"ps-2 ms-1 mt-n1 \"><span class=\"fw-semibold \">예술의전당 토월극장</span></div>\r\n");
      out.write("                        </a>\r\n");
      out.write("                    </div>\r\n");
      out.write("                </article>\r\n");
      out.write("            </div>\r\n");
      ...
      out.write("            <div class=\"masonry-grid-item\">\r\n");
      out.write("                <article class=\"card card-hover\">\r\n");
      out.write("                    <a class=\"card-img-top\" href=\"blog-single-rs.html\"><img src=\"img/blog/sa.jpg\" alt=\"Post thumbnail\"></a>\r\n");
      out.write("                    <div class=\"card-body\">\r\n");
      out.write("                        <h2 class=\"h5 nav-heading mb-3\"><a href=\"blog-single-rs.html\">사춘기 메들리</a></h2>\r\n");
      out.write("                        <a class=\"meta-link fs-sm mb-2\" href=\"#\">2022.07.09 ~ 2022.09.25</a>\r\n");
      out.write("                        <a class=\"d-flex meta-link fs-sm align-items-center pt-3\" href=\"https://map.kakao.com/?urlX=501139.0&urlY=1133244.0&name=%EC%9A%B0%EB%A6%AC%EC%86%8C%EA%B7%B9%EC%9E%A5\">\r\n");
      out.write("                            <i class=\"fa-solid fa-landmark\" alt=\"Emma Brown\"></i>\r\n");
      out.write("                            <div class=\"ps-2 ms-1 mt-n1 \"><span class=\"fw-semibold \">우리소극장</span></div>\r\n");
