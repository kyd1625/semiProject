 ...
 * Generated at: 2022-11-20 13:06:41 UTC
...
public final class QnA_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginMember != null){ 
	...
	if(searchParamValue != null && searchParamValue.length() > 0){
      ...
      out.write("                </svg>\r\n");
      out.write("\r\n");
      out.write("                    <strong style=\"margin-bottot:-120px;\">문의 게시판</strong>\r\n");
      out.write("                    \r\n");
      out.write("            <form action=\"");
      out.print(path);
      out.write("/QnaWrite\" method=\"get\" style=\"text-align:right; font-size:25px; margin-top:-20px; margin-right:50px;\">\r\n");
      out.write("                    <button style=\"background-color:#9A161F; border:0; padding-top:5px; padding-right:15px; padding-left:15px; padding-bottom:5px; color:white\" type=\"button\" onclick=\"location.href='");
      out.print(path);
      out.write("/QnaWrite'\">문의하기</button>\r\n");
      out.write("            </form>\r\n");
      out.write("                </div>\r\n");
      out.write("                <style>\r\n");
      out.write("                    .color1 {\r\n");
...
for(Qna b : list){ 
      ...
      out.print(path+"/QnaView?boardNo="+b.getNo());
      out.write('"');
      out.write('>');
      ...
      out.write("                   ");
      out.write("\r\n");
      out.write("\t<div id=\"pageBar\" style=\"text-align:center; margin-top:25px; font-size:25px; padding-right:15px; padding-left:15px;\">\r\n");
      out.write("\t\t");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t<button onclick=\"location.href='");
      out.print(path);
      out.write("/QnA_list?page=");
