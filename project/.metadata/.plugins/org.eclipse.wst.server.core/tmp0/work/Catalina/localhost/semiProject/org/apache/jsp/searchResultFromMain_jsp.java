 ...
 * Generated at: 2022-08-21 23:47:49 UTC
...
public final class searchResultFromMain_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginMember != null){ 
	...
	if(request.getAttribute("recommenList")!=null){
      ...
      out.write("                        <option value=\"gyeonggi\" selected>경기</option>\r\n");
      ...
      out.write("                        <input class=\"form-control rounded date-picker\" type=\"text\" placeholder=\"Choose date\" data-datepicker-options=\"{&quot;altInput&quot;: true, &quot;altFormat&quot;: &quot;F j, Y&quot;, &quot;dateFormat&quot;: &quot;Y-m-d&quot;, &quot;defaultDate&quot;: &quot;today&quot;, &quot;minDate&quot;: &quot;today&quot;}\"\r\n");
      ...
      out.write("\r\n");
      out.write("                    \t\r\n");
      out.write("                        <article class=\"card card-horizontal card-hover mb-grid-gutter \" style=\"height:250px;\">\r\n");
      out.write("                            <a class=\"card-img-top\" href=\"");
      out.print(path );
      out.write("/detailFromMain?prfmid=");
      out.print(showList.get(i).getPrfid() );
      ...
      out.write('"');
      out.write('>');
      out.print(showList.get(i).getPrfnm() );
      out.write("</a></h2>\r\n");
      out.write("                                <p class=\"mb-0 fs-sm text\">");
      out.print(showList.get(i).getGenrenm() );
      out.write(' ');
      out.write('|');
      out.write(' ');
      out.print(showList.get(i).getPrfstate() );
      out.write(' ');
      out.write('|');
      out.write(' ');
      out.print(showList.get(i).getPrfage() );
      out.write("</br>\r\n");
      out.write("                                \t\r\n");
      out.write("                                    공연기간 :");
      out.print(showList.get(i).getPrfpdfrom() );
      out.write(' ');
      out.write('-');
      out.write(' ');
      out.print(showList.get(i).getPrfpdto() );
      out.write(" <br>\r\n");
      out.write("                                    ");
 if(showList.get(i).getPrfcast()!=null){
      ...
      out.write("\r\n");
      out.write("                                    \t<p>출연진 : ");
      out.print(showList.get(i).getPrfcast() );
      out.write("</p>\r\n");
      out.write("                                    ");
 ...
 if(showList.get(i).getPrfcast()!=null){
      ...
      out.write("    <div class=\"container py-4 mb-20 mb-sm-0 pb-sm-10\">\r\n");
      out.write("        <nav aria-label=\"breadcrumb\">\r\n");
      out.write("        </nav>\r\n");
 ...
 if(recommenList!=null && recommenList.size()>0){
      ...
      out.write("                <article class=\"card card-hover\"  style=\"height:410px;\">\r\n");
      out.write("                    <a class=\"card-img-top\"style=\"height:250px; href=\"#\"><img src=\"");
      out.print(recommenList.get(i).getPoster() );
      out.write("\" alt=\"Post thumbnail\"></a>\r\n");
      out.write("                    <div class=\"card-body\">\r\n");
      out.write("                        <h2 class=\"h5 nav-heading mb-3\"><a href=\"");
      out.print(path);
      out.write("/detailFromMain?prfmid=");
      out.print(recommenList.get(i).getPrfid() );
      out.write('"');
      out.write('>');
      out.print(recommenList.get(i).getPrfnm() );
      out.write("</a></h2>\r\n");
      out.write("                        <a class=\"meta-link fs-sm mb-2\" href=\"#\">");
      out.print(recommenList.get(i).getPrfpd());
      out.write("</a>\r\n");
      ...
      out.write("                            <div class=\"ps-2 ms-1 mt-n1 \"><span class=\"fw-semibold \">");
      out.print(recommenList.get(i).getPrfplcnm() );
      out.write("</span></div>\r\n");
      out.write("                        </a>\r\n");
      out.write("                    </div>\r\n");
      out.write("                </article>\r\n");
